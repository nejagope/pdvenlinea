...
use Multinet\PdvEnlinea\PdvEnlineaBundle\Entity\CategoriaProducto;
use Multinet\PdvEnlinea\PdvEnlineaBundle\Form\CategoriaProductoType;
...
class CategoriaProductoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PdvBundle:CategoriaProducto')->findBy(array(
            'status' => 1
        ));
     ...
     * @Method("POST")
     * @Template("PdvBundle:CategoriaProducto:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PdvBundle:CategoriaProducto')->find($id);
    ...
    */
     ...
     * @Method("POST")
     * @Template("PdvBundle:CategoriaProducto:edit.html.twig")
     */
